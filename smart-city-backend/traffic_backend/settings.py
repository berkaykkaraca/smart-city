...
SECRET_KEY = "django-insecure-2$7g!2!ax9s)+&sn)91(bqah#bb8q%f9z*i78@bfbq=6p@+$9x"
...
# Google Pub/Sub configuration (can be overridden by environment variables)
GOOGLE_CLOUD_PROJECT = os.getenv("GOOGLE_CLOUD_PROJECT", "your-gcp-project-id")
PUBSUB_TOPIC = os.getenv("PUBSUB_TOPIC", "traffic-events")
PUBSUB_SUBSCRIPTION = os.getenv("PUBSUB_SUBSCRIPTION", "traffic-events-sub")
